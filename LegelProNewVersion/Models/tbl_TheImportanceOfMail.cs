...
{
    public class tbl_TheImportanceOfMail
    {
        [Key]
        public int TheImportanceOfMailId { get; set; }
        [Required, MaxLength(50)]
        public string TheImportanceOfMailArabicName { get; set; }
        [Required, MaxLength(50)]
        public string TheImportanceOfMailEnglishName { get; set; }
